...
namespace com.arpoise.arpoiseapp.GrowingWaste
{
    public class Creature
    {
        ...
        public static string Weights
        {
            get
            {
                return _weight1.Weight.ToString("F3", CultureInfo.InvariantCulture) + " "
                    + _weight2.Weight.ToString("F3", CultureInfo.InvariantCulture) + " "
                    + _weight3.Weight.ToString("F3", CultureInfo.InvariantCulture) + " "
                    + _weight4.Weight.ToString("F3", CultureInfo.InvariantCulture) + " "
                    + _weight5.Weight.ToString("F3", CultureInfo.InvariantCulture);
            }
        }
        ...
        public string FitnessString
        {
            get
            {
                ...
                return fitness.ToString("F2", CultureInfo.InvariantCulture);
            }
        }
